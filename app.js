...
var manager_infomt=require("./managerInfo.js")
var manager_caps=require("./capitalizeName.js");
const userInfo = require("./userInfo.js");
console.log(manager_caps(manager_infomt.manager_role));
console.log(manager_infomt.manager_role.toUpperCase());
console.log(manager_infomt.manager_role.length);
function Display(mgr_role)
{ 
    let position=mgr_role.search("inventory")
    if(position!==-1)
    {
        return position;
    }
...
console.log("inventory:",Display(manager_infomt.manager_role));